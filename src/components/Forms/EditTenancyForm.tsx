...
export default function EditTenancyForm({ tenancy }: Props) {
  ...
  const [updateTenancy, setUpdateTenancy] = React.useState<ITenancy>(
    tenancy as ITenancy
  );
  const [tenantOne, setTenantOne] = React.useState<ITenant>(
    defaultTenantOne as ITenant
  );
  const [tenantTwo, setTenantTwo] = React.useState<ITenant>(
    defaultTenantTwo as ITenant
  );
        ...
        /> */}
            ...
            <input
              ...
              onChange={(e) =>
                setUpdateTenancy({
                  ...updateTenancy,
                  assignmentOfLease: e.target.checked,
                })
              }
            />
            <label>Pet?</label>
            <input
              ...
              onChange={(e) =>
                setUpdateTenancy({ ...updateTenancy, pet: e.target.checked })
              }
            />
            {/* <input
          type="file"
